...
//   makes the video modals stop playing when modal is closed
  $("#headerVideoModal").on('hidden.bs.modal', function (e) {
    $("#headerVideoModal iframe").attr("src", $("#headerVideoModal iframe").attr("src"));
  }); 

  $("#video1Modal").on('hidden.bs.modal', function (e) {
    $("#video1Modal iframe").attr("src", $("#video1Modal iframe").attr("src"));
  }); 
  ...
  $("#video3Modal").on('hidden.bs.modal', function (e) {
    $("#video3Modal iframe").attr("src", $("#video3Modal iframe").attr("src"));
  }); 

  $("#video4Modal").on('hidden.bs.modal', function (e) {
    $("#video4Modal iframe").attr("src", $("#video4Modal iframe").attr("src"));
  }); 
